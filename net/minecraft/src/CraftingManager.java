...
public class CraftingManager
{
    ...
    private CraftingManager()
    {
        ...
        addShapelessRecipe(new ItemStack(Item.field_77821_bF, 1), new Object[]
                {
        ...
        addRecipe(new ItemStack(Block.jukebox, 1), new Object[]
                {
                    "###", "#X#", "###", '#', Block.planks, 'X', Item.field_77702_n
                });
        ...
        addRecipe(new ItemStack(Block.field_72079_ak, 6, 3), new Object[]
                {
                    "###", '#', Block.cobblestone
                });
        addRecipe(new ItemStack(Block.field_72079_ak, 6, 0), new Object[]
                {
                    "###", '#', Block.stone
                });
        addRecipe(new ItemStack(Block.field_72079_ak, 6, 1), new Object[]
                {
                    "###", '#', Block.sandStone
                });
        addRecipe(new ItemStack(Block.field_72079_ak, 6, 4), new Object[]
                {
                    "###", '#', Block.brick
                });
        addRecipe(new ItemStack(Block.field_72079_ak, 6, 5), new Object[]
                {
                    "###", '#', Block.stoneBrick
                });
        addRecipe(new ItemStack(Block.field_72092_bO, 6, 0), new Object[]
                {
                    "###", '#', new ItemStack(Block.planks, 1, 0)
                });
        addRecipe(new ItemStack(Block.field_72092_bO, 6, 2), new Object[]
                {
                    "###", '#', new ItemStack(Block.planks, 1, 2)
                });
        addRecipe(new ItemStack(Block.field_72092_bO, 6, 1), new Object[]
                {
                    "###", '#', new ItemStack(Block.planks, 1, 1)
                });
        addRecipe(new ItemStack(Block.field_72092_bO, 6, 3), new Object[]
                {
        ...
        addRecipe(new ItemStack(Block.field_72072_bX, 4), new Object[]
                {
                    "#  ", "## ", "###", '#', new ItemStack(Block.planks, 1, 2)
                });
        addRecipe(new ItemStack(Block.field_72074_bW, 4), new Object[]
                {
                    "#  ", "## ", "###", '#', new ItemStack(Block.planks, 1, 1)
                });
        addRecipe(new ItemStack(Block.field_72070_bY, 4), new Object[]
                {
                    "#  ", "## ", "###", '#', new ItemStack(Block.planks, 1, 3)
                });
        ...
        addRecipe(new ItemStack(Block.field_72088_bQ, 4), new Object[]
                {
                    "#  ", "## ", "###", '#', Block.sandStone
                });
        ...
        addRecipe(new ItemStack(Block.field_72064_bT, 2), new Object[]
                {
