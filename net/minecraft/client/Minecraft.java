...
public abstract class Minecraft implements Runnable, IPlayerUsage
{
    ...
    private void runGameLoop()
    {
        ...
        if (func_71387_A() && field_71439_g != null && field_71439_g.sendQueue != null && isGamePaused != flag)
        {
            ((MemoryConnection)field_71439_g.sendQueue.func_72548_f()).func_74437_a(isGamePaused);
        }
    ...
    public void runTick()
    {
        ...
        if (currentScreen == null && field_71439_g != null)
        {
            ...
            else if (field_71439_g.isPlayerSleeping() && field_71441_e != null)
            {
